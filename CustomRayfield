...
Blackout = {
	...
	SliderBackground = Color3.fromRGB(60, 0, 0),
	...
	ToggleDisabled = Color3.fromRGB(70, 0, 0),
	ToggleEnabledStroke = Color3.fromRGB(255, 30, 30),
	ToggleDisabledStroke = Color3.fromRGB(80, 0, 0),
	ToggleEnabledOuterStroke = Color3.fromRGB(100, 0, 0),
	ToggleDisabledOuterStroke = Color3.fromRGB(40, 0, 0),

	DropdownSelected = Color3.fromRGB(45, 0, 0),
	DropdownUnselected = Color3.fromRGB(25, 0, 0),
